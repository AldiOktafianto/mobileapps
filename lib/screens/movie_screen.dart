...
import 'package:netflix_/models/movie_model.dart';
import 'package:netflix_/screens/trailer.dart';
import 'package:netflix_/widgets/circular_clipper.dart';
import 'package:netflix_/widgets/content_scroll.dart';
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      IconButton(
                        padding: EdgeInsets.only(left: 30.0),
                        onPressed: () {
                          services.updateListener(widget.movie, context);
                        },
                      ...
                      child: RawMaterialButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(
                              MaterialPageRoute(builder: (context) => Trailer(data: widget.movie.video_trailer)
                              ));
                          },
                        shape: CircleBorder(),
